...
async function fetchReport() {
  ...
  return {totalTokens,cacheTokens:totalCacheTokens,models:models.size,modelUsage:[...modelUsage].map(([model,tokens])=>({model,tokens})).sort((a,b)=>b.tokens-a.tokens),days:7,daily};
}
